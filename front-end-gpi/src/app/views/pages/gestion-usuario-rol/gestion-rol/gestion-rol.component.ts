...
export class GestionRol implements OnInit {
    ...
    constructor(private gestionUsuariosRoles:GestionUsuariosRoles,private modalService: NgbModal ) { }
    ...
    listarRoles(){
      ...
      registrarRol():void{  
        ...
        //this.modalAvisos.mostrarCargando("Guardando...")
        this.gestionUsuariosRoles.registrarRol(rol).subscribe(
          response=>{
          //  this.modalAvisos.cerrarModal();
            this.modalService.dismissAll();
            this.listarRoles();
            //this.modalAvisos.mostrarResultado("Rol guardado correctamente.","success")
          },err=>{
            //this.modalAvisos.cerrarModal();
            //this.modalAvisos.mostrarResultado("Error al guardar el rol","error");
          }
        )
      }
      ...
      editarRol(content,rol):void {
        ...
        console.log("Entra a editar rol");
        this.nombreRol="";
        this.descRol="";
        this.consultarSubmenu(rol);  
        this.titulo=rol==null?"Crear Rol":"Editar Rol"
        this.rolEditando=rol//==null?0:rol
        //this.selectedTipolId=rol==null?this.selectedTipolId=null:rol.tipoUsuario.id
      ...
      consultarSubmenu(rol:RolSeg) {
        this.gestionUsuariosRoles.listarMenuOpciones().subscribe(
         ...
         // this.modalAvisos.mostrarResultado("Error al listar las opciones "+err.error.error,"error")
          }
        )
      }
      ...
      buscarRol():void{
        ...
        console.log(this.rolesCompletos)
